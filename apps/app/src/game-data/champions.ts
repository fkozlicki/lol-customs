// Generated by scripts/generate-game-data.ts from Data Dragon 16.19.1. Do not edit by hand.

/** The patch this file was generated from; the fallback when the live patch cannot be fetched. */
export const GENERATED_PATCH = "16.19.1";
...
export const CHAMPIONS: Record<number, { name: string; image: string }> = {
  ...
  799: { name: "Ambessa", image: "Ambessa.png" },
  800: { name: "Mel", image: "Mel.png" },
  804: { name: "Yunara", image: "Yunara.png" },
  805: { name: "Locke", image: "Locke.png" },
  ...
  904: { name: "Zaahen", image: "Zaahen.png" },
